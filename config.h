...
static const char *browsercmd[]  = { "google-chrome-stable", " --disk-cache-dir=/tmp/chrome/ "};
//static const char *browsercmd[]  = { "/home/z/.local/applications/dwm/dwm-6.2/chrome.sh", NULL};
